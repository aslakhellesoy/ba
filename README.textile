...
h3. Creating a new happening (conference, meeting, whatever)

# Create a new page (or edit an existing one)
# Select "Happening" from the page type dropdown list

In order to set up a complete happening, this page will need several page parts in addition to body. These have to be named
as follows:

* *attendances/new*: This is where you design your signup form. You should use <r:ba:signup /> here.
* *attendances/show*: This is where you design the signup confirmation page.
* *attendances/already*: This is where you design the "you have already signed up" page.

Do not add these parts in the admin interface. Instead, save the page without any additional parts, and these special
parts will be created for you. They are prepopulated with sample usage of the Ba tags.

All of the Ba tags are documented in more detail in Radiant's admin interface. You can see this documentation
by choosing the "Available Tags" link while editing a page and entering r:ba in the search box.
...
Make sure each happening has a price with an empty code. Users who sign up for a happening without specifying
