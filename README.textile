...
A new HappeningPage will also have a "signup_confirmation_email" part for signup confirmation emails. More on that below.
...
the same form and input fields. The login page has published status by default.
